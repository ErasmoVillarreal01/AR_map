    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          ElevatedButton(onPressed: _handlePressButton, child: const Text("Search Places"), style: ButtonStyle(
            backgroundColor: MaterialStateProperty.all(Colors.blue), // Set the background color to blue
          ),)
        ],
      ),
    );
